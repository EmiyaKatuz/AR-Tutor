...
1. If you want to track the actual objects, you *MUST* import your customized object data into Unity and replace the
   existing ones. Below is detailed information for creating customized object data.

    - Multi Targets

   Firstly, design and prepare your images for each side of the Multi-Target, fulfilling the matching dimensions and
ratings of a good Multi-Target. The second step is to create the Multi-Target through the Vuforia Target Manager.
...
3. Windows 10 and 11, Unity Editor 2022 LTS 2022.3.16f1+, and Visual Studio 2022 version 17.8.5+ are required for Windows. (
...
7. You will need an Apple developer account to build on a real iOS device.
...
1. Running in Unity
   ...
   To test any function in Unity, you must first tick the test tick box in the Object `Result`. Then, you can select
